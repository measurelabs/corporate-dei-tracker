...
import { SanityArticle, urlFor } from '@/lib/sanity'
import { format } from 'date-fns'
import { Calendar, ArrowLeft, Share2, Building2, FileText } from 'lucide-react'
...
export function ArticleContent({ article }: ArticleContentProps) {
  ...
  useEffect(() => {
    if (article?.body) {
      const extractedHeadings = extractHeadings(article.body)
